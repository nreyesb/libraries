...
This library aims to provide the contract to use StorageDriver process.
...
# automaticaly call open() after creating and call close() after ending
with LocalStorageDriver(root) as storage_driver:
    data: bytes = storage_driver.get("data.txt")
```
